let Restaurant,Review,validateReviewData,validateRestaurantData,validateRestaurantUpdateData,createConnection,sequelize;_a4a‍.w("./models/Restaurant",[["default",["Restaurant"],function(v){Restaurant=v}]]);_a4a‍.w("./models/Review",[["default",["Review"],function(v){Review=v}]]);_a4a‍.w("./validators/review.validator",[["validateReviewData",["validateReviewData"],function(v){validateReviewData=v}]]);_a4a‍.w("./validators/restaurant.validator",[["validateRestaurantData",["validateRestaurantData"],function(v){validateRestaurantData=v}],["validateRestaurantUpdateData",["validateRestaurantUpdateData"],function(v){validateRestaurantUpdateData=v}]]);_a4a‍.w("./utils/dbconnection.util",[["createConnection",["createConnection"],function(v){createConnection=v}],["sequelize",["sequelize"],function(v){sequelize=v}]]);require("dotenv").config();
...
app.post("/api/v1/restaurants", async (req, res) => {
  _a4a‍.g.console.log('postreq', req.body);
